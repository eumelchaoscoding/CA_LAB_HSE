...
inext1:   ldaa 0,x        ; get command
          ...
          ;-----> sanity check
          CMPB #$0        ;check if B is zero after decremting B
...
msg_out:                  ; output the message character by character
          ldab #17        ; max. 16 characters                            ;--------> BUG 2 
...
padding:
          ;if string ist to short add padding with spaces
          ldaa #$20       ;load space ' ' 
          decb            ; decrement number
          BEQ wEnd        ; if 16 chars on lcd stop the loop 
          JSR outputByte  ; else: add space
          BRA padding
          
wEnd:     pulx            ;restore original registers
          puld
          rts
